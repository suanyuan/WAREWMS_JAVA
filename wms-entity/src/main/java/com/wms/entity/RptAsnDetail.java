...
/**
 * The persistent class for the RPT_ASN_DETAIL database table.
 * 
 */
@Entity
@Table(name="RPT_ASN_DETAIL")
@NamedQuery(name="RptAsnDetail.findAll", query="SELECT r FROM RptAsnDetail r")
public class RptAsnDetail implements Serializable {
