...
//	private static final String JSP_PATH = "D:\\InsertList\\CodeGenerator\\";
	...
	private static final String QUERY_PACKAGE_NAME = "com.wms.query";
	private static final String DAO_PACKAGE_NAME = "com.wms.dao";
	private static final String SERVICE_PACKAGE_NAME = "com.wms.service";
	private static final String CONTROLLER_PACKAGE_NAME = "com.wms.controller";
	
	private static final Boolean IS_NEED_COMBOBOX = true;
	
	public static void main(String[] args) {
		CodeGenerator generator = new CodeGenerator(new DocAsnCertificate());
		generator.genData();
	}
	...
	public String voGenerator(String objClsName, boolean isForm, boolean isQuery){
		...
		sb.append(";").append("\n\n")
		  ...
		  .append("import com.wms.utils.serialzer.JsonDatetimeSerializer;\n").append("\n")
	...
	private String daoGenerator(String objClsName) {
		...
		sb.append("package ").append(DAO_PACKAGE_NAME).append(";\n\n")
		  ...
		  .append("import org.hibernate.Criteria;\n")
		  .append("import org.hibernate.criterion.MatchMode;\n")
		  .append("import org.hibernate.criterion.Projections;\n")
		  .append("import org.hibernate.criterion.Restrictions;\n")
		  .append("import org.springframework.stereotype.Repository;\n")
		  .append("import com.wms.entity.").append(objClsName).append(";\n")
		  .append("import com.wms.easyui.EasyuiDatagridPager;\n")
		  .append("import com.wms.query.").append(objClsName).append("Query;\n\n")
		  .append("@Repository(\"").append(objClsName.replaceFirst(String.valueOf(objClsName.charAt(0)), String.valueOf(objClsName.charAt(0)).toLowerCase())).append("Dao\")\n")
		  .append("public class ").append(objClsName).append("Dao extends BaseDao<").append(objClsName).append(", String, ").append(objClsName).append("Query> {\n\n")
		  .append("\tpublic List<").append(objClsName).append("> getPagedDatagrid(EasyuiDatagridPager pager, ").append(objClsName).append("Query query) {\n")
		  .append("\t\tCriteria criteria = this.getQueryCriteria(query);\n")
		  .append("\t\tcriteria.setFirstResult((pager.getPage() - 1) * pager.getRows());\n")
		  .append("\t\tcriteria.setMaxResults(pager.getRows());\n")
		  .append("\t\tcriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);\n")
		  .append("\t\treturn criteria.list();\n")
		  .append("\t}\n\n")
		  .append("\tpublic Long countAll(").append(objClsName).append("Query query) {\n")
		  .append("\t\tCriteria criteria = this.getQueryCriteria(query);\n")
		  .append("\t\tcriteria.setProjection(Projections.count(\"id\"));\n")
		  .append("\t\treturn (Long)criteria.uniqueResult();\n")
		  .append("\t}\n\n")
		  .append("\tprotected Criteria getQueryCriteria(").append(objClsName).append("Query query){\n")
		  .append("\t\tStringBuilder sb = new StringBuilder();\n")
		  .append("\t\tCriteria criteria = this.createCriteria();\n");
		...
		for(Field field : fields){
			if(!"id".equals(field.getName()) && !"serialVersionUID".equals(field.getName())){
				...
				if(typeName.indexOf("String") > 0){
					sb.append("\t\tif(StringUtils.isNotEmpty(query.get")
					  .append(field.getName().substring(0, 1).toUpperCase())
					  .append(field.getName().substring(1, field.getName().length())).append("())){\n")
					  .append("\t\t\tcriteria.add(Restrictions.like(\"").append(field.getName()).append("\", query.get")
					  .append(field.getName().substring(0, 1).toUpperCase())
					  .append(field.getName().substring(1, field.getName().length())).append("(), MatchMode.ANYWHERE));\n")
					  .append("\t\t}\n");
				}else if(typeName.indexOf("int") > 0 ||
							typeName.indexOf("Integer") > 0 || 
								typeName.indexOf("Double") > 0 || 
									typeName.indexOf("Long") > 0 ||
										typeName.indexOf("Decimal") > 0){
					sb.append("\t\tif(query.get")
					  .append(field.getName().substring(0, 1).toUpperCase())
					  .append(field.getName().substring(1, field.getName().length())).append("() != null){\n")
					  .append("\t\t\tcriteria.add(Restrictions.eq(\"").append(field.getName()).append("\", query.get")
					  .append(field.getName().substring(0, 1).toUpperCase())
					  .append(field.getName().substring(1, field.getName().length())).append("()));\n")
					  .append("\t\t}\n");
				}
	...
	private String serviceGenerator(String objClsName) {
		...
		sb.append("package ").append(SERVICE_PACKAGE_NAME).append(";\n\n")
		  ...
		  .append("import com.wms.dao.").append(objClsName).append("Dao;\n")
		  .append("import com.wms.entity.").append(objClsName).append(";\n")
		  .append("import com.wms.vo.").append(objClsName).append("VO;\n")
		  .append("import com.wms.vo.Json;\n");
		if(IS_NEED_COMBOBOX){
			sb.append("import com.wms.easyui.EasyuiCombobox;\n");
		}
		sb.append("import com.wms.easyui.EasyuiDatagrid;\n")
		  .append("import com.wms.easyui.EasyuiDatagridPager;\n")
		  .append("import com.wms.vo.form.").append(objClsName).append("Form;\n")
	      .append("import com.wms.query.").append(objClsName).append("Query;\n\n")
	      ...
	      .append("\t\tList<").append(objClsName).append("> ").append(str).append("List = ").append(str).append("Dao.getPagedDatagrid(pager, query);\n")
	      ...
	      .append("\t\t}\n")
	      .append("\t\tdatagrid.setTotal(").append(str).append("Dao.countAll(query));\n")
	      ...
	      .append("\t\t").append(str).append("Dao.save(").append(str).append(");\n")
	      ...
	      .append("\t\tJson json = new Json();\n")
	      .append("\t\t").append(objClsName).append(" ").append(str).append(" = ").append(str).append("Dao.findById(").append(str).append("Form.get").append(objClsName).append("Id());\n")
	      .append("\t\tBeanUtils.copyProperties(").append(str).append("Form, ").append(str).append(");\n")
	      ...
	      .append("\t\tJson json = new Json();\n")
	      .append("\t\t").append(objClsName).append(" ").append(str).append(" = ").append(str).append("Dao.findById(id);\n")
		...
		if(IS_NEED_COMBOBOX){
			sb.append("\tpublic List<EasyuiCombobox> get").append(objClsName).append("Combobox() {\n")
		      ...
		      .append("\t\tList<").append(objClsName).append("> ").append(str).append("List = ").append(str).append("Dao.findAll();\n")
	...
	private String controllerGenerator(String objClsName) {
		...
		sb.append("import java.util.Map;\n")
		  ...
		  .append("import com.wms.mybatis.entity.SfcUserLogin;\n")
		  .append("import com.wms.service.").append(objClsName).append("Service;\n")
		  .append("import com.wms.utils.ResourceUtil;\n")
		  .append("import com.wms.utils.annotation.Login;\n")
		  .append("import com.wms.vo.Json;\n")
		  .append("import com.wms.vo.").append(objClsName).append("VO;\n");
		if(IS_NEED_COMBOBOX){
			sb.append("import com.wms.easyui.EasyuiCombobox;\n");
		...
		sb.append("import com.wms.easyui.EasyuiDatagrid;\n")
		  ...
		  .append("\t\treturn ").append(str).append("Service.getBtn(id, (SfcUserLogin)session.getAttribute(ResourceUtil.getUserInfo()));\n")
		  .append("\t}\n\n");
	...
	private String jspGenerator(String objClsName) {
		...
		sb.append("\t});\n")
		  ...
		  .append("\t\t\t\t<fieldset>\n")
		  .append("\t\t\t\t\t<legend><spring:message code='common.button.query'/></legend>\n")
		  .append("\t\t\t\t\t<table>\n")
		  .append("\t\t\t\t\t\t<tr>\n");
		i = 0;
		for(Field field : fields){
