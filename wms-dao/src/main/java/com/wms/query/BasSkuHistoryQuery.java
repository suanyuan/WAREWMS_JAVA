...
public class BasSkuHistoryQuery implements IQuery {
	...
	private String shelflifealertdays;
	...
	public String getInboundlifedays() {
		return inboundlifedays;
	}

	public void setInboundlifedays(String inboundlifedays) {
	...
	public String getOutboundlifedays() {
		return outboundlifedays;
	}

	public void setOutboundlifedays(String outboundlifedays) {
	...
	public String getFirstinbounddate() {
		return firstinbounddate;
	}

	public void setFirstinbounddate(String firstinbounddate) {
	...
	public String getShelflifealertdays() {
		return shelflifealertdays;
	}

	public void setShelflifealertdays(String shelflifealertdays) {
