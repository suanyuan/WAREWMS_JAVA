...
public class RptOrdershipmentSkuQuery implements IQuery {
	...
	private java.math.BigDecimal qtyEach;
	...
	public java.math.BigDecimal getQtyEach() {
		return qtyEach;
	}

	public void setQtyEach(java.math.BigDecimal qtyEach) {
