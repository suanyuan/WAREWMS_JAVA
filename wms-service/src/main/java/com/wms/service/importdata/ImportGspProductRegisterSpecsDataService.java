...
//			}
	...
	/*private List<GspProductRegisterSpecsVO> listToBean(List<ImportAsnData> asnList, StringBuilder resultMsg) {
...
//	@Transactional
//	private void saveAsn(List<GspProductRegisterSpecsVO> importDataList, StringBuilder resultMsg) {
...
//				//赋值
//				gspProductRegisterSpecs.setSpecsId(resultNo);
//				gspProductRegisterSpecs.setProductRegisterId("PR");
//				gspProductRegisterSpecs.setSpecsName("Y");
...
//				//保存订单主信息
//				docAsnHeaderMybatisDao.add(gspProductRegisterSpecs);
//				for (GspProductRegisterSpecsVO importDetailsDataVO : importDataVO.getDocAsnDetailVOList()) {
