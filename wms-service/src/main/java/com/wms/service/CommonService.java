...
public class CommonService extends BaseService{
    ...
    CommonVO adjustScanResult(ScanResultForm form) {
        ...
        //bas_gtn_lotatt
        BasSku basSku = null;
        List<BasSku> basSkuList = basSkuMybatisDao.query4ScanInBasGtnLotatt(pdaBasSkuQuery);
        if (basSkuList.size() == 1) basSku = basSkuList.get(0);
     ...
     */
    Json matchPaDetail(PdaDocPaDetailQuery query) {
