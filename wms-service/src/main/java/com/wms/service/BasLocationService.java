...
//				sb.append(order.getTotalNum()).append("/").append(i+1);
            form.setField("quantity", basLocation.getAddwho());
            sb.setLength(0);
...
//				sb.insert(0, order.getOrderCode());
            ...
            form.replacePushbuttonField("packageBarcodeImg2", PDFUtil.genPdfButton(form, "packageBarcodeImg2", BarcodeGeneratorUtil.genBarcode(sb.toString(), 800)));
            sb.setLength(0);
...
//			logger.error(ExceptionUtil.getExceptionMessage(e));
    ...
    public BasLocation queryEmptyLocation(int pageNum) {
        ...
        mybatisCriteria.setPageSize(1);
        BasLocation basLocation = basLocationMybatisDao.queryEmptyLocation(mybatisCriteria);
     ...
     * 释放库位的推荐状态
     */
    public void releaseOccupiedLocation(String locationid) {
