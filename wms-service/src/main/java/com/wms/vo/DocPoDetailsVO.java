...
public class DocPoDetailsVO {
	...
	private String polinestatusName;
	...
	public void setPolineno(Double polineno) {
	...
	public Double getOrderedqtyEach() {
		return orderedqtyEach;
	}

	public void setOrderedqtyEach(Double orderedqtyEach) {
