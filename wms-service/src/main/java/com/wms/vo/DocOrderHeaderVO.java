...
public class DocOrderHeaderVO {
	...
	private List<DocOrderDetailVO> docOrderDetailVOList;
	...
	public List<DocOrderDetailVO> getDocOrderDetailVOList() {
		return docOrderDetailVOList;
	}

	public void setDocOrderDetailVOList(List<DocOrderDetailVO> docOrderDetailVOList) {
		this.docOrderDetailVOList = docOrderDetailVOList;
	}
}