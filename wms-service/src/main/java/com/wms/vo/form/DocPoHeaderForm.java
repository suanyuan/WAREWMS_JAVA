...
public class DocPoHeaderForm {

	private String pono;
	private String potype;
	private String postatus;
	private java.util.Date pocreationtime;
	...
	public java.util.Date getPocreationtime() {
		return pocreationtime;
	}

	public void setPocreationtime(java.util.Date pocreationtime) {
