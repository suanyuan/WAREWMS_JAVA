...
public class WaybillStatisticsForm {

	private String token;
	private String waybillStatisticsId;
	...
	public String getWaybillStatisticsId() {
		return waybillStatisticsId;
	}

	public void setWaybillStatisticsId(String waybillStatisticsId) {
		this.waybillStatisticsId = waybillStatisticsId;
	}
