...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		...
		columns : [[
			{field: 'transactionid',		title: '事务编号',	width: 121 },
			{field: 'transactiontypeName',		title: '事务类型',	width: 124 },
			{field: 'docno',		title: '单据编号',	width: 134 },
			{field: 'doclineno',		title: '单据行号',	width: 114 },
			{field: 'doctypeName',		title: '单据类型',	width: 124 },
			{field: 'statusName',		title: '事务状态',	width: 124 },
			{field: 'transactiontime',		title: '事务时间',	width: 138 },
			{field: 'fmcustomerid',		title: 'FM客户编码',	width: 134 },
			{field: 'fmsku',		title: 'FM商品编码',	width: 124 },
			{field: 'fmqtyEach',		title: 'FM单位数量',	width: 124 },
			{field: 'fmqty',		title: 'FM库存数量',	width: 124 },
			{field: 'fmuomName',		title: 'FM单位',	width: 134 },
			{field: 'fmlocation',		title: 'FM库位',	width: 134 },
			{field: 'fmlotnum',		title: 'FM批号',	width: 134 },
			{field: 'fmlotatt01',		title: 'FM生产日期',	width: 128 },
			{field: 'fmlotatt02',		title: 'FM失效日期',	width: 128 },
			{field: 'fmlotatt03',		title: 'FM入库日期',	width: 128 },
			{field: 'fmlotatt04',		title: 'FM库存状态',	width: 124 },
			{field: 'fmlotatt05',		title: 'FM序列号',	width: 124 },
			{field: 'fmlotatt06',		title: 'FM产品注册证',	width: 124 },
            {field: 'fmlotatt07',		title: 'FM灭菌批号',	width: 124 },
            {field: 'fmlotatt08',		title: 'FM供应商',	width: 124 },
            {field: 'fmlotatt09',		title: 'FM样品属性',	width: 124 },
            {field: 'fmlotatt10',		title: 'FM质量状态',	width: 124 },
            {field: 'fmlotatt11',		title: 'FM存储条件',	width: 124 },
            {field: 'fmlotatt12',		title: 'FM产品名称',	width: 124 },
            {field: 'fmlotatt13',		title: 'FM双证',	width: 124 },
            {field: 'fmlotatt14',		title: 'FM入库单号',	width: 124 },
            {field: 'fmlotatt15',		title: 'FM生产厂商名称',	width: 124 },
			...
			{field: 'fmpackid',		title: 'FM箱号',	width: 104 },
			{field: 'tocustomerid',		title: 'TO客户编码',	width: 104 },
			{field: 'tosku',		title: 'TO商品编码',	width: 104 },
			{field: 'toqtyEach',		title: 'TO单位数量',	width: 104 },
			{field: 'toqty',		title: 'TO库存数量',	width: 104 },
			{field: 'touomName',		title: 'TO单位',	width: 104 },
			{field: 'totalcubic',		title: 'TO体积',	width: 104 },
			{field: 'totalgrossweight',		title: 'TO重量',	width: 104 },
			...
			{field: 'tolotatt04',		title: 'TO库存状态',	width: 104 },
			{field: 'tolotatt05',		title: 'TO序列号',	width: 104 },
			{field: 'tolotatt06',		title: 'TO产品注册证',	width: 104 },
            {field: 'tolotatt07',		title: 'TO灭菌批号',	width: 104 },
            {field: 'tolotatt08',		title: 'TO供应商',	width: 104 },
            {field: 'tolotatt09',		title: 'TO样品属性',	width: 104 },
            {field: 'tolotatt10',		title: 'TO质量状态',	width: 104 },
            {field: 'tolotatt11',		title: 'TO存储条件',	width: 104 },
            {field: 'tolotatt12',		title: 'TO产品名称',	width: 104 },
            {field: 'tolotatt13',		title: 'TO双证',	width: 104 },
            {field: 'tolotatt14',		title: 'TO入库单号',	width: 104 },
            {field: 'tolotatt15',		title: 'TO生产厂商名称',	width: 104 },
            // {field: 'tolotatt16',		title: 'TO批次属性16',	width: 74 },
            // {field: 'tolotatt17',		title: 'TO批次属性17',	width: 74 },
            // {field: 'tolotatt18',		title: 'TO批次属性18',	width: 74 },


			{field: 'topackid', 	title: 'TO箱号',	width: 104 },
			{field: 'reasoncode',		title: '原因代码',	width: 104 },
			{field: 'reason',		title: '原因',	width: 104 },
			{field: 'addtime',		title: '系统时间',	width: 108 },
			{field: 'editwho',		title: '系统人员',	width: 104 },
			{field: 'operator',		title: '操作人员',	width: 104 },
			{field: 'transactiontype',		title: '事务类型C',	width: 104 },
			{field: 'doctype',		title: '单据类型C',	width: 104 },
			{field: 'status',		title: '单据状态C',	width: 104 }
