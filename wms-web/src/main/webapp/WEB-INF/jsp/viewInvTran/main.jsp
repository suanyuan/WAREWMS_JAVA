...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		...
		columns : [[
			...
			{field: 'fmcustomerid',		title: 'FM客户编码',	width: 94 },
			{field: 'fmsku',		title: 'FM商品编码',	width: 124 },
			{field: 'fmqtyEach',		title: 'FM单位数量',	width: 94 },
			{field: 'fmqty',		title: 'FM库存数量',	width: 104 },
			...
			{field: 'fmlotatt04',		title: 'FM库存状态',	width: 104 },
			{field: 'fmlotatt05',		title: 'FM序列号',	width: 104 },
			{field: 'fmlotatt06',		title: 'FM产品注册证',	width: 104 },
            {field: 'fmlotatt07',		title: 'FM灭菌批号',	width: 104 },
            {field: 'fmlotatt08',		title: 'FM供应商',	width: 104 },
            {field: 'fmlotatt09',		title: 'FM样品属性',	width: 104 },
            {field: 'fmlotatt10',		title: 'FM质量状态',	width: 104 },
            {field: 'fmlotatt11',		title: 'FM存储条件',	width: 104 },
            {field: 'fmlotatt12',		title: 'FM产品名称',	width: 104 },
            {field: 'fmlotatt13',		title: 'FM双证',	width: 104 },
            {field: 'fmlotatt14',		title: 'FM入库单号',	width: 104 },
            {field: 'fmlotatt15',		title: 'FM生产厂商名称',	width: 104 },
