...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		...
		singleSelect:true,
		columns : [[
			{field: 'documentNo',		title: '单据号',	width: 130},
			{field: 'soasndate',		title: '日期',	width: 90 },
			{field: 'documentType',		title: '单据类型',	width: 90 },
			{field: 'warehouse',		title: '仓库',	width: 90 },
			{field: 'customerid',		title: '供货单位',	width: 150 },
			{field: 'sku',		        title: '存货编码',	width: 120 },
			{field: 'descrc',		    title: '规格型号',	width: 120 },
			{field: 'asnqtyeach',		title: '入库数量',	width: 90 },
			{field: 'asnqty',	        title: '入库件数',	width: 90 },
			{field: 'soqtyeach',        title: '出库数量 ',	width: 90 },
			{field: 'soqty',		    title: '出库件数',	width: 90 },
