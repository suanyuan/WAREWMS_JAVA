...
$(function () { 
	...
	$("input",$("#loginForm #username").next("span")).blur(function(){
		$("#loginForm #warehouseId").combobox({
			url:'loginController.do?getWarehouseCombobox&id='+this.value,
			valueField: 'id',
			textField: 'value'
		});
	});
