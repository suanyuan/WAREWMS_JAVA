...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		url : '<c:url value="/drugInspectionController.do?showSearchOutInvLocationHistoryDatagrid"/>',
		method:'POST',
		toolbar : '#toolbar',
		title: '',
		pageSize : 50,
		...
		columns : [[
			...
			{field: 'lotatt03',		        title: '出库日期',	width: 100,formatter:dateFormat2},
			...
			{field: 'addtime',		        title: '制单日期 ',	width: 100},
...
var doExport = function(){
    if(navigator.cookieEnabled){
		...
		//--导出Excel
        var formId = ajaxDownloadFile(sy.bp()+"/drugInspectionController.do?exportSearchOutInvLocationHistoryDataToExcel", param);
			...
			<div id='toolbar' class='datagrid-toolbar' style='padding: 5px;'>
				<fieldset>
					...
					<table style="text-align: right">
						...
						<tr>
							<th>生产批号/序列号</th><td><input type='text' id='lotatt04' class='easyui-textbox' size='16' data-options=''/></td>
