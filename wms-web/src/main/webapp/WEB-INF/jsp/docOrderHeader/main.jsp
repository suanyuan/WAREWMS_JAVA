...
$(function() {
	...
	ezuiDetailsDatagrid = $('#ezuiDetailsDatagrid').datagrid({
		...
		columns : [[
			...
			{field: 'qtyorderedEach',		title: '订货数',		width: 130 },
            {field: 'qtyordered',		title: '订货件数',		width: 130 },
			{field: 'qtyallocatedEach',		title: '分配数',		width: 130 },
            {field: 'qtyallocated',		title: '分配件数',		width: 130 },
			{field: 'qtypickedEach',		title: '拣货数',		width: 130 },
            {field: 'qtypicked',		title: '拣货件数',		width: 130 },
			{field: 'qtyshippedEach',		title: '发货数',		width: 130 },
