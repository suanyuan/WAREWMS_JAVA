...
<div id='ezuiDetailsDialog' class='easyui-dialog' style='padding: 10px;'>
    <form id='ezuiDetailsForm' method='post'>
        ...
        <table>
            <tr>
                <th>SO编号</th>
                <td><input type='text' name='orderno' id='orderno' class='easyui-textbox' size='16'
                           data-options='editable:false'/></td>
                <th>客户编码</th>
                <td><input type='text' name='customerid' id='customerid' class='easyui-textbox' size='16'
                           data-options='editable:false'/></td>
                <th>行号</th>
                <td><input type='text' name='orderlineno' id='orderlineno' class='easyui-numberbox' size='16'
                           data-options='editable:false'/></td>
                <th>状态</th>
            ...
            <tr>
                <th>生产日期</th>
                <td><input type='text' name='lotatt01' id='lotatt01' class='easyui-datebox' size='16' data-options=''/>
                </td>
                <th>效期</th>
                <td><input type='text' name='lotatt02' id='lotatt02' class='easyui-datebox' size='16' data-options=''/>
                </td>
                <th>入库日期</th>
                <td><input type='text' name='lotatt03' id='lotatt03' class='easyui-datebox' size='16' data-options=''/>
                </td>
                <th>生产批号</th>
            ...
            <tr>
                ...
                <th>入库单号</th>
                <td><input type='text' name='lotatt14' id='lotatt14' class='easyui-textbox' size='16' data-options=''/>
                </td>
            </tr>
        </table>
        ...
        <div style="display: none;">
            <table>
                <th>[+件数]分配数C</th>
                <td><input type='text' name='qtyallocated' id='qtyallocated' class='easyui-numberbox' size='16'
                           data-options='editable:false,min:0,precision:0'/></td>
                <th>拣货数C</th>
                <td><input type='text' name='qtypicked' id='qtypicked' class='easyui-numberbox' size='16'
                           data-options='editable:false,min:0,precision:0'/></td>
                <th>发货数C</th>
                <td><input type='text' name='qtyshipped' id='qtyshipped' class='easyui-numberbox' size='16'
                           data-options='editable:false,min:0,precision:0'/></td>
                <th>重量C</th>
                <td><input type='text' name='grossweight' id='grossweight' class='easyui-numberbox' size='16'
                           data-options='required:true,min:0,precision:3'/></td>
                <th>体积C</th>
                <td><input type='text' name='cubic' id='cubic' class='easyui-numberbox' size='16'
                           data-options='required:true,min:0,precision:3'/></td>
                <th>金额C</th>
                <td><input type='text' name='price' id='price' class='easyui-numberbox' size='16'
                ...
                <th>产品注册证C</th>
                <td><input type='text' name='lotatt06' id='lotatt06' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>灭菌批号C</th>
                <td><input type='text' name='lotatt07' id='lotatt07' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>存储条件C</th>
                <td><input type='text' name='lotatt11' id='lotatt11' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>产品名称C</th>
                <td><input type='text' name='lotatt12' id='lotatt12' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>生产厂商名称C</th>
                <td><input type='text' name='lotatt15' id='lotatt15' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>自定义批属1C</th>
                <td><input type='text' name='lotatt16' id='lotatt16' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>自定义批属2C</th>
                <td><input type='text' name='lotatt17' id='lotatt17' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>自定义批属3C</th>
                <td><input type='text' name='lotatt18' id='lotatt18' class='easyui-textbox' size='16' data-options=''/>
                </td>
                <th>双证C</th>
                <td><input type='text' name='lotatt13' id='lotatt13' class='easyui-textbox' size='16' data-options=''/>
                </td>
            </table>
