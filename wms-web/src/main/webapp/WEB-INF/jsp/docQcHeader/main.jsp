...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		...
		columns : [[
			...
			{field: 'userdefine4',		title: '序列号',	width: 110 },
			{field: 'userdefine3',		title: '生产批号',	width: 110 },
			...
			{field: 'lotatt12',		title: '产品名称',	width: 160 },
			{field: 'lotatt06',		title: '产品注册证',	width: 200 },
			{field: 'lotatt07',		title: '灭菌编号',	width: 200 },
			{field: 'lotatt15',		title: '生产厂家',	width: 200 },
			{field: 'lotatt11',		title: '存储条件',	width: 200 },
