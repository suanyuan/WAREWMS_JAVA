...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		url : '<c:url value="/rptOrderPackingboxController.do?showDatagrid"/>',
		method:'POST',
		toolbar : '#toolbar',
		title: '',
		pageSize : 50,
		...
		columns : [[
            ...
            {field: 'carrierid',		title: '承运人',	width: 50 },
            {field: 'soreference1',		title: '参考编号1',	width: 110 },
			{field: 'soreference2',		title: '参考编号2',	width: 110 },
			{field: 'sku',		title: '商品编码 ',	width: 80 },
			{field: 'descrC',		title: '商品名称',	width: 180 },
			{field: 'qty',		title: '装箱数',	width: 80 },
			{field: 'addtime',		title: '装箱时间',	width: 130 },
			{field: 'consigneeid',		title: '收货方',	width: 50 },
			{field: 'tel',		title: '电话',	width: 110 },
			{field: 'address',		title: '地址',	width: 250 },
			{field: 'alternateSku1',		title: '商品条码',	width: 110 }	
		]],
		...
		onRowContextMenu : function(event, rowIndex, rowData) {
			...
			ajaxBtn($('#menuId').val(), '<c:url value="/rptOrderPackingboxController.do?getBtn"/>', ezuiMenu);
			$(this).datagrid('unselectAll');
		}
	});
...
var del = function(){
	...
	if(row){
		$.messager.confirm('<spring:message code="common.message.confirm"/>', '<spring:message code="common.message.confirm.delete"/>', function(confirm) {
			if(confirm){
				$.ajax({
					url : 'rptOrderPackingboxController.do?delete',
					data : {id : row.id},
					type : 'POST',
					dataType : 'JSON',
...
var commit = function(){
	var url = '';
	if (processType == 'edit') {
		url = '<c:url value="/rptOrderPackingboxController.do?edit"/>';
	}else{
		url = '<c:url value="/rptOrderPackingboxController.do?add"/>';
	}
...
var doSearch = function(){
	ezuiDatagrid.datagrid('load', {
		address : $('#address').val(),
		addtime : $('#addtime').val(),
		alternateSku1 : $('#alternateSku1').val(),
...
var doExport = function(){
	if(navigator.cookieEnabled){
		...
		//--导出Excel
		var formId = ajaxDownloadFile(sy.bp()+"/rptOrderPackingboxController.do?exportOrderPackDataToExcel", param);
...
<body>
	...
	<div id='ezuiDialog' style='padding: 10px;'>
		<form id='ezuiForm' method='post'>
			<input type='hidden' id='rptOrderPackingboxId' name='rptOrderPackingboxId'/>
			<table>
				<tr>
					<th>待输入0</th>
				...
				<tr>
					<th>待输入2</th>
					<td><input type='text' name='alternateSku1' class='easyui-textbox' size='16' data-options='required:true'/></td>
				</tr>
				<tr>
					<th>待输入3</th>
				...
				<tr>
					<th>待输入12</th>
					<td><input type='text' name='tel' class='easyui-textbox' size='16' data-options='required:true'/></td>
				</tr>
				<tr>
					<th>待输入13</th>
