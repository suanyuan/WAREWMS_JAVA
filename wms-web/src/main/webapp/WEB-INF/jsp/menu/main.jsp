...
$(function() {
	...
	ezuiTreegrid = $('#ezuiTreegrid').treegrid({
		...
		treeField : 'menuName',
		columns : [[  
			{field:'menuName',	title:"<spring:message code='menu.datagrid.menuName'/>", width:120},  
			{field:'url',		title:"<spring:message code='menu.datagrid.url'/>",	width:150},  
			{field:'displaySeq',title:"<spring:message code='menu.datagrid.displaySeq'/>", width:40},
			{field:'roleSet',	title:"<spring:message code='menu.datagrid.roleSet'/>", width:70,
...
<body>
	...
	<div id="ezuiDialog" style="padding: 10px;">
		<form id="ezuiForm" method="post">
			...
			<table>
				<tr>
					<th><spring:message code='menu.datagrid.menuType'/></th>
					<td>
						<input type="text" id="menuTypeCombobox" class="easyui-combobox" name="menuType" size='16' data-options="	panelHeight:'auto',
																																	...
																																	textField: 'value',
																																	data: [
																																		{id: '0', value: '<spring:message code="menu.datagrid.menuType.0"/>'},
																																		{id: '1', value: '<spring:message code="menu.datagrid.menuType.1"/>'}
																																	],
					...
					<th><spring:message code='menu.datagrid.menuName'/></th>
					<td><input type="text" name="menuName" class="easyui-textbox" size='16' data-options='required:true'/></td>
					<th><spring:message code="menu.datagrid.displaySeq"/></th>
					<td><input type="text" id="displaySeq" name="displaySeq" class="easyui-numberbox" size='16' data-options="required:true,max:100"/></td>
				</tr>
				<tr>
					<th><spring:message code='menu.datagrid.url'/></th>
					<td colspan="5"><input type="text" id="url" name="url" class="easyui-textbox" size='75' data-options='required:true'/></td>
				</tr>
				<tr>
				...
				<tr>
					<th><spring:message code="menu.datagrid.roleSet"/></th>
					<td colspan="5">
						<input type="text" id="roleCombobox" name="roleList" class="easyui-combobox" size='43' style="height:60px" data-options="	required:true,
																																					panelHeight:'auto',
																																					multiple:'multiple',
																																					multiline:true,
																																					editable:false,
