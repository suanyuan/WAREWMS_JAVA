...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		...
		columns : [[
			...
			{field: 'lotatt06',		    title: '产品注册证号/备案凭证号',	width: 160 },
			{field: 'lotatt01',		    title: '生产日期',	width: 130 },
			{field: 'lotatt02',		    title: '有效期/失效期',	width: 130 },
...
var doExport = function(){
    if(navigator.cookieEnabled){
        ...
        //--导出Excel
        var formId = ajaxDownloadFile(sy.bp()+"/statisticalAnalysisController.do?exportAsnListDataToExcel", param);
