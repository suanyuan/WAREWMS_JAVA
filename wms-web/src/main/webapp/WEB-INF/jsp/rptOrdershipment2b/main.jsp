...
$(function() {
	...
	ezuiDatagrid = $('#ezuiDatagrid').datagrid({
		url : '<c:url value="/rptOrdershipment2bController.do?showDatagrid"/>',
		method:'POST',
		toolbar : '#toolbar',
		title: '',
		pageSize : 50,
		...
		columns : [[
			...
			{field: 'cnt',		title: '系统箱数',	width: 80 },
			{field: 'edi09',		title: '订单重量',	width: 80 },
			{field: 'edi10',		title: '订单体积',	width: 80 },
			{field: 'addtime',		title: '创建时间 ',	width: 130 },
			{field: 'lastshipmenttime',		title: '发运时间 ',	width: 130 },
			{field: 'consigneeid',		title: '收件人N',	width: 100 },
			{field: 'consigneename',		title: '收件人I',	width: 60 },
			{field: 'cTel1',		title: '电话1',	width: 110 },
			{field: 'cTel2',		title: '电话2',	width: 110 },
			...
			{field: 'codenameC',		title: '订单类型 ',	width: 70 },
			{field: 'notes',		title: '客户备注 ',	width: 100 }
		]],
		...
		onRowContextMenu : function(event, rowIndex, rowData) {
			...
			ajaxBtn($('#menuId').val(), '<c:url value="/rptOrdershipment2bController.do?getBtn"/>', ezuiMenu);
			$(this).datagrid('unselectAll');
		}
	});
...
var del = function(){
	...
	if(row){
		$.messager.confirm('<spring:message code="common.message.confirm"/>', '<spring:message code="common.message.confirm.delete"/>', function(confirm) {
			if(confirm){
				$.ajax({
					url : 'rptOrdershipment2bController.do?delete',
					data : {id : row.id},
					type : 'POST',
					dataType : 'JSON',
...
var commit = function(){
	var url = '';
	if (processType == 'edit') {
		url = '<c:url value="/rptOrdershipment2bController.do?edit"/>';
	}else{
		url = '<c:url value="/rptOrdershipment2bController.do?add"/>';
	}
...
var doExport = function(){
	if(navigator.cookieEnabled){
		...
		//--导出Excel
		var formId = ajaxDownloadFile(sy.bp()+"/rptOrdershipment2bController.do?exportOrderShip2bDataToExcel", param);
...
<body>
			...
			<div id='toolbar' class='datagrid-toolbar' style='padding: 5px;'>
				<fieldset>
					...
					<table>
						...
						<tr>
							<th>创建时间：</th>
							<td><input type='text' id='addtime' class='easyui-datetimebox' size='16' data-options='editable:false,required:false,showSeconds:true'/></td>
							<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;至</th><td><input type='text' id='addtimetext' class='easyui-datetimebox' size='16'  data-options='editable:false,required:false,showSeconds:true'/></td>
						</tr>	
							<th>发运时间：</th>
	...
	<div id='ezuiDialog' style='padding: 10px;'>
		<form id='ezuiForm' method='post'>
			<input type='hidden' id='rptOrdershipment2bId' name='rptOrdershipment2bId'/>
			<table>
				<tr>
					<th>待输入0</th>
				...
				<tr>
					<th>待输入5</th>
					<td><input type='text' name='cTel1' class='easyui-textbox' size='16' data-options='required:true'/></td>
				</tr>
				<tr>
					<th>待输入6</th>
					<td><input type='text' name='cTel2' class='easyui-textbox' size='16' data-options='required:true'/></td>
				</tr>
				<tr>
					<th>待输入7</th>
				...
				<tr>
					<th>待输入12</th>
					<td><input type='text' name='edi09' class='easyui-textbox' size='16' data-options='required:true'/></td>
				</tr>
				<tr>
					<th>待输入13</th>
					<td><input type='text' name='edi10' class='easyui-textbox' size='16' data-options='required:true'/></td>
				</tr>
				<tr>
					<th>待输入14</th>
