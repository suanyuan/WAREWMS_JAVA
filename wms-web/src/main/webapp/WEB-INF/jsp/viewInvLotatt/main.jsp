...
// 			{field: 'netweight',		title: '净重',	width: 71 },
			...
			{field: 'lotatt01',		title: '生产日期',	width: 90 },
			{field: 'lotatt02',		title: '失效日期',	width: 90 },
			{field: 'lotatt03',		title: '入库日期',	width: 90 },
			{field: 'lotatt04',		title: '库存状态',	width: 80 },
			{field: 'lotatt05',		title: '批属5',	width: 71 },
			{field: 'lotatt06',		title: '批属6',	width: 150 },
