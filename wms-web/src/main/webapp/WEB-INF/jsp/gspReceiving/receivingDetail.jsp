        ...
        <fieldset>
            ...
            <table style="text-align: right">
                ...
                <tr>
                    <th>收货单位</th>
                    <td colspan="">
                        <input type='text' id="enterpriseN" name='enterpriseName' size='16' class='easyui-textbox'
                               data-options='required:true'/>

                    </td>

                    <th>收货单位代码</th>
                    <td><input type='text' id="enterpriseNo" style="width: 150px;" name='enterpriseNo'
                               value='${gspEnterpriseInfo.enterpriseNo}' size='16' class='easyui-textbox'
                               data-options='required:true'/></td>
                    <th>收货单位简称</th>
                    <td><input type='text' id="s" style="width: 150px" name='shorthandName' size='16'
                               value='${gspEnterpriseInfo.shorthandName}' class='easyui-textbox'
                               data-options='required:true'/></td>
                </tr>
                <tr>
                    <th>供应商</th>
                    <td colspan="">
                        <input type='text' name='supplierId' id="supplier" size="16" class='easyui-textbox'
                               data-options='required:true'/>
                    ...
                    <th>货主</th>
                    <td>
                        <input type='text' name='clientId' id="client" style="width: 150px" size='16'
                               value='${gspReceiving.clientId}' class='easyui-textbox' data-options='required:true'/>
                ...
                <tr>
                    <th>是否医废</th>
                    <td><input type='text' name='isReturn' id="return" style="width: 150px;float: left"
                               class='easyui-combobox' value="${gspReceiving.isReturn}" size="16"
                               data-options='required:true,editable:false'/>


                    </td>
                    <th>是否有效</th>
                    <td><input type='text' name='isUse' style="width: 150px" id="use" class='easyui-combobox'
                               value="${gspReceiving.isUse}" size="16" data-options='required:true,editable:false'/>
                    </td>


                    <th>是否需要审核</th>
                    <td><input type='text' name='isCheck' style="width: 150px" id="isChec"
                               value="${gspReceiving.isCheck}" class='easyui-combobox' size="16"
    ...
    <div id='TB' class='datagrid-toolbar' style=''>
        <fieldset>
            ...
            <table>
                <tr>
                    <th>客户代码：</th>
                    <td><input id="kehudaima" type='text' class='easyui-textbox' data-options=''/></td>
                    <th>客户名称：</th>
                    <td><input id="kehumingcheng" type='text' class='easyui-textbox' data-options=''/></td>
    ...
    <div id='clientTB' class='datagrid-toolbar' style=''>
        <fieldset>
            ...
            <table>
                <tr>
                    <th>客户代码：</th>
                    <td><input type='text' id='kehudaima1' class='easyui-textbox' data-options=''/></td>
                    <th>客户名称：</th>
                    <td><input type='text' id='kehumingcehng1' class='easyui-textbox' data-options=''/></td>
                </tr>
                <tr>
                 <td>
                    </td>
